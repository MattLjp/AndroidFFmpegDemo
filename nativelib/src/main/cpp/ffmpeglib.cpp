...
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1GetFFmpegVersion(JNIEnv *env,
                                                                      jclass obj) {
...
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1Init(JNIEnv *env, jobject obj, jstring jurl,
                                                          int playerType, jint renderType,
                                                          jobject surface) {
...
//    player->Init(env, obj, const_cast<char *>(url), playerType, renderType, surface);
    ...
    ffMediaPlayer->Init(env, obj, const_cast<char *>(url), renderType, surface);
...
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1Play(JNIEnv *env, jobject obj,
                                                          jlong player_handle) {
    if (player_handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1SeekToPosition(JNIEnv *env, jobject thiz,
                                                                    jlong player_handle,
                                                                    jfloat position) {
    if (player_handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1Pause(JNIEnv *env, jobject obj,
                                                           jlong player_handle) {
    if (player_handle != 0) {
//        PlayerWrapper *ffMediaPlayer = reinterpret_cast<PlayerWrapper *>(player_handle);
        FFMediaPlayer *ffMediaPlayer = reinterpret_cast<FFMediaPlayer *>(player_handle);
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1Stop(JNIEnv *env, jobject obj,
                                                          jlong player_handle) {
    if (player_handle != 0) {
//        PlayerWrapper *ffMediaPlayer = reinterpret_cast<PlayerWrapper *>(player_handle);
        FFMediaPlayer *ffMediaPlayer = reinterpret_cast<FFMediaPlayer *>(player_handle);
...
JNIEXPORT void JNICALL Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1UnInit
...
JNIEXPORT jlong JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1GetMediaParams(JNIEnv *env, jobject thiz,
                                                                    jlong player_handle,
                                                                    jint param_type) {
    long value = 0;
    if (player_handle != 0) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1SetMediaParams(JNIEnv *env, jobject thiz,
                                                                    jlong player_handle,
                                                                    jint param_type,
                                                                    jobject param) {
    if (player_handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1OnSurfaceCreated(JNIEnv *env,
                                                                      jclass clazz,
                                                                      jint render_type) {
    switch (render_type) {
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1OnSurfaceChanged(JNIEnv *env,
                                                                      jclass clazz,
                                                                      jint render_type,
                                                                      jint width,
                                                                      jint height) {
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1OnDrawFrame(JNIEnv *env,
                                                                 jclass clazz,
                                                                 jint render_type) {
    switch (render_type) {
        case VIDEO_GL_RENDER:
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1SetGesture(JNIEnv *env,
                                                                jclass clazz,
                                                                jint render_type,
...
JNIEXPORT void JNICALL
Java_com_matt_nativelib_ffmpeg_FFMediaPlayer_native_1SetTouchLoc(JNIEnv *env,
                                                                 jclass clazz,
                                                                 jint render_type,
                                                                 jfloat touch_x,
                                                                 jfloat touch_y) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1CreateContext(JNIEnv *env,
                                                                            jobject thiz) {
    MediaRecorderContext::CreateContext(env, thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1DestroyContext(JNIEnv *env,
                                                                             jobject thiz) {
    MediaRecorderContext::DeleteContext(env, thiz);
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1Init(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1UnInit(JNIEnv *env, jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1StartRecord(JNIEnv *env, jobject thiz,
                                                                          jint recorder_type,
                                                                          jstring out_url,
                                                                          jint frame_width,
                                                                          jint frame_height,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1OnAudioData(JNIEnv *env, jobject thiz,
                                                                          jbyteArray data,
                                                                          jint size) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1OnPreviewFrame(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jint format,
                                                                             jbyteArray data,
                                                                             jint width,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1StopRecord(JNIEnv *env,
                                                                         jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1SetTransformMatrix(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jfloat translate_x,
                                                                                 jfloat translate_y,
                                                                                 jfloat scale_x,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1OnSurfaceCreated(JNIEnv *env,
                                                                               jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1OnSurfaceChanged(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint width,
                                                                               jint height) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1OnDrawFrame(JNIEnv *env,
                                                                          jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1SetFilterData(JNIEnv *env,
                                                                            jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_matt_nativelib_recorder_MediaRecorderContext_native_1SetFragShader(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jint index,
                                                                            jstring str) {
