...
void MediaRecorder::AddStream(AVOutputStream *ost, AVFormatContext *oc, const AVCodec **codec,
                              AVCodecID codec_id) {
...
int MediaRecorder::OpenAudio(AVFormatContext *oc, const AVCodec *codec, AVOutputStream *ost) {
...
int MediaRecorder::OpenVideo(AVFormatContext *oc, const AVCodec *codec, AVOutputStream *ost) {
