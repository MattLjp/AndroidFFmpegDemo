...
import static com.matt.nativelib.ffmpeg.FFMediaPlayer.VIDEO_RENDER_3D_VR;
import static com.matt.nativelib.ffmpeg.FFMediaPlayer.VR_3D_GL_RENDER;
...
public class VRMediaPlayerActivity extends AppCompatActivity implements GLSurfaceView.Renderer, FFMediaPlayer.EventCallback, MyGLSurfaceView.OnGestureCallback, SensorEventListener {
    ...
    private String mVideoPath = getCacheDir() + "/byteflow/vr.mp4";
